...
Test(evalexpr, evalexp9)
{
    ...
    //char str[90] = "-(12*(13+15/5*(6/(12+14%(30%5+(10*25)-46)+16)-20)/43)*20)*(-(12-98*42)*(16+63-50/3))";
    //char str[90] = "-(12*(13+15/5*(6/(12+14%(30%5+(10*25)-46)+16)-20)/43)*20)";
    //char *str = "-(12*(13+15/5*(6/(12+14%(30%5+(10*25)-46)+16)-20)/43)*20)";
    //char str[90] = "10*25";
    //char str[90] = "(30%5+(10*25)-46)";
    //char str[90] = "(12+14%(30%5+(10*25)-46)+16)";
    //char str[90] = "(6/(12+14%(30%5+(10*25)-46)+16)-20)";
    //char str[90] = "(13+15/5*(6/(12+14%(30%5+(10*25)-46)+16)-20)/43)";
    //char str[90] = "(-(12-98*42)*(16+63-50/3))";
    //char str[90] = "5*6+7*(4*2+(-10*10/4))";
